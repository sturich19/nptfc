#!/usr/bin/env python3
"""Standalone helpers for Polaris task prompt management.
...
def _import_shared() -> ModuleType:
    ...
    # Strategy 2: sibling file (.polaris/scripts/tasks/task_helpers_shared.py)
    ...
    raise ImportError(
        ...
        "Ensure polaris-cli is installed (pip install polaris-cli) "
