...
**Inputs**: Design documents from `/polaris-specs/[###-feature-name]/`
...
**Prompt Files**: Each work package references a matching prompt file in `/tasks/` generated by `/polaris.tasks`. Treat this file as the high-level checklist; keep deep implementation detail inside the prompt files.
