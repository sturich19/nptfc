...
**Note**: Task generation in main is standard for all Polaris missions. Implementation happens in per-WP worktrees.
...
7. **Report**:
   ...
   - MVP recommendation
   - Next command: `/polaris.implement WP01` (or review tasks.md first)
