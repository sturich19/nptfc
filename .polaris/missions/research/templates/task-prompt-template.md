...
> **Populated by `/polaris.review`** – Reviewers add detailed feedback here when research needs revision. Each item must be addressed before returning for re-review.
...
- Link to supporting specs: `.polaris/memory/constitution.md`, `polaris-specs/.../plan.md` (methodology), `polaris-specs/.../spec.md` (research question), `research.md`, `data-model.md`.
