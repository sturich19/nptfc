...
This location is SEPARATE from `polaris-specs/` planning artifacts.
...
**Do NOT use**:
- `polaris-specs/` (reserved for sprint planning artifacts)
...
|------|----------|---------|
| **Planning Artifacts** | `polaris-specs/[###]/research/` | Evidence/sources collected DURING planning (shared across WPs) |
| **Research Deliverables** | `[deliverables_path]/` | Actual research OUTPUT (created in worktrees, merged to main) |

## Project Structure

### Sprint Planning Artifacts (in polaris-specs/)
```
polaris-specs/[###-research]/
